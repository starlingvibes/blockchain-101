...
(async function createDistributionAccount() {
  ...
  try {
    ...
    let parentAccount = await server.loadAccount(
      distributorKeyPair.publicKey()
    ...
    await createAccountTx.sign(distributorKeyPair);
    ...
    console.log('Created the new account', distributorKeyPair.publicKey());
  } catch (e) {
    console.error('ERROR!', e);
  }
})();

// module.exports = createDistributionAccount;
